# fabrique_test_task
Проект разработан на python 3.9, Django, DRF, Celery
...
# Выполненные пункты Дополнительных Задач:
...
- Клонируем проект командой "git clone https://github.com/Den4ik-Bro/fabrique_test_task.git"
...
- Запустить celery командой celery -A core -l info
- Запустить flower celery -A core flower (будет доступен по адресу 127.0.0.1:5555)

# Запуск проекта с использоавнием Docker
- Создаем директорию под проект, создаем виртуальное окружение и активируем его
- Клонируем проект командой "git clone https://github.com/Den4ik-Bro/fabrique_test_task.git"
- Выполнить команды "docker-compose build" > "docker_compose up" 
- Проект будет доступен по адресу 127.0.0.1:8000 flower по адресу 127.0.0.1:5555
